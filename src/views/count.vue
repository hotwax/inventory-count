      ...
      <ion-content>
        ...
        <div class="product-info">
          ...
          <div class="product-features">
            <ion-item lines="none">
              <ion-chip v-if="$filters.getFeature(product.featureHierarchy, '1/COLOR/')" class="pointer">
                <ion-icon :icon="colorPaletteOutline" />
                <ion-label>{{ $filters.getFeature(product.featureHierarchy, '1/COLOR/') }}</ion-label>
              </ion-chip>
              <ion-chip v-if="$filters.getFeature(product.featureHierarchy, '1/SIZE/')" class="pointer">
        ...
        <div v-if="segmentSelected === 'count'" class="inventory-form">
          ...
          <ion-item>
            ...
            <ion-chip @click="selectLocation" class="pointer">
