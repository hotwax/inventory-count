<template>
  <ion-page>
    ...
    <ion-content>
        ...
        <div class="filters">
          <ion-list class="ion-padding">
            ...
            <ion-item>
              ...
              <ion-button slot="end" size="small" class="date-time-button" style="solid" >3rd March 2024</ion-button>
              <ion-modal class="date-time-modal">
      ...
      <div class="list-item product border">
        <ion-item>
